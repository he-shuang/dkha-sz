...
import com.dkha.feign.fallback.ParamsFeignClientFallbackFactory;
 ...
 * 参数接口
 */
@FeignClient(name = ServiceConstant.AIRPORTPAC_ADMIN_SERVER, contextId = "ParamsFeignClient", fallback = ParamsFeignClientFallbackFactory.class)
