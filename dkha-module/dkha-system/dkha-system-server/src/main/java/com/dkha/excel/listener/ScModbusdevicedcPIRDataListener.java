 ...
 */
@Slf4j
public class ScModbusdevicedcPIRDataListener extends AnalysisEventListener<ScModbusdevicedcExcel> {
...
//                    nullList.add(scModbusdevicedcExcel);
           ...
           /* if (CollectionUtils.isNotEmpty(errorList)) {
            ...
            if (CollectionUtils.isNotEmpty(repeatList)) {
                throw new RenException("重复设备序列号为:" + repeatList);
            }
    ...
    private ScModbusdevicedcEntity excelCheck(ScModbusdevicedcExcel sc, ScModbusdevicedcEntity sentity) throws ParseException {
        ...
        sentity.setMbdDevicetype(Constant.FAIL);
