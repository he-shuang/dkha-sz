...
//        8) 最后得到的 CRC寄存器内容即为 CRC码。
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<8;i++) {
            ...
            String str16 = "010500" + hex + "0000";
            byte[] bytes = HexUtil.toBytes(str16);
            System.out.println(str16+getCRC3(bytes));
        }
...
//       String strtest="010500010000";
//        byte[] bytes = HexUtil.toBytes(strtest);
